                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    @php
                                        ...
                                        } elseif ($order->status == 'processsing') {
                                            $status = '<span
                                                class="bg-yellow-500 py-1 px-3 rounded text-white shadow">New</span>';
                                        } elseif ($order->status == 'shipped') {
                                            $status = '<span
                                                class="bg-green-500 py-1 px-3 rounded text-white shadow">New</span>';
                                        } elseif ($order->status == 'delivered') {
                                            $status = '<span
                                                class="bg-green-700 py-1 px-3 rounded text-white shadow">New</span>';
                                        } elseif ($order->status == 'cancelled') {
                                            $status = '<span
                                                class="bg-red-500 py-1 px-3 rounded text-white shadow">New</span>';
                                        }
